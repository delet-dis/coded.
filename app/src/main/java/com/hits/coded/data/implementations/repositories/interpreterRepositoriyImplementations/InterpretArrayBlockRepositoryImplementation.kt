...
@Inject constructor(private val heapUseCases: HeapUseCases, private val convertorsUseCases: ConvertorsUseCases,
                    private val currentIdValue: CurrentIdValue):InterpretArrayBlockRepository(){
    override suspend fun interpretArrayBlock(block: ArrayBlockBase): Any { block.id?.let {
        ...
        return when (block.arrayBlockType) {
            ...
            ArrayBlockType.GET_ELEMENT -> array[convertorsUseCases.convertAnyToIntUseCase.convertAnyToInt(block.value)]
